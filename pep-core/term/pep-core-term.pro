...
unix|win32: LIBS += -L$$OUT_PWD/../asm/ -lpep-core-asm

INCLUDEPATH += $$PWD/../asm
DEPENDPATH += $$PWD/../asm

win32:!win32-g++: PRE_TARGETDEPS += $$OUT_PWD/../asm/pep-core-asm.lib
else:unix|win32-g++: PRE_TARGETDEPS += $$OUT_PWD/../asm/libpep-core-asm.a

unix|win32: LIBS += -L$$OUT_PWD/../cpu/ -lpep-core-cpu

INCLUDEPATH += $$PWD/../cpu
DEPENDPATH += $$PWD/../cpu

win32:!win32-g++: PRE_TARGETDEPS += $$OUT_PWD/../cpu/pep-core-cpu.lib
else:unix|win32-g++: PRE_TARGETDEPS += $$OUT_PWD/../cpu/libpep-core-cpu.a
