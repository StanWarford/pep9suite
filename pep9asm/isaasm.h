...
public:
    ...
    static bool processSourceLine(SymbolTable* symTable, BURNInfo& info, int& byteCount, QString sourceLine, int lineNum, AsmCode *&code, QString &errorString, bool &dotEndDetected, bool hasBreakpoint = false);
    // Pre: sourceLine has one line of source code.
