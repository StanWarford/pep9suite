...
void CPUHelpDialog::onCurrentItemChanged(QTreeWidgetItem*, QTreeWidgetItem*) {
    ...
    if (!isHelpSubCat && row == eUSINGPEP9CPU) { // Using Pep/9 CPU
        ...
        if (!isHelpSubCat) {
            ...
            if (row == eFIG1205) {
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1205.pepcpu"));
                ...
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1207.pepcpu"));
                ui->helpFigureLabel->setText("<b>Figure 12.7</b> Combining cycles of Figure 12.5.");
            }
            else if (row == eFIG1209) {
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1209.pepcpu"));
                ...
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1210.pepcpu"));
                ...
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1211.pepcpu"));
                ...
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1212.pepcpu"));
                ...
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1214.pepcpu"));
        ...
        if (!isHelpSubCat) {
            ...
            ui->helpSplitter->widget(1)->show();
            if (row == eFIG1220) {
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1220.pepcpu"));
                ...
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1221.pepcpu"));
                ...
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/fig1223.pepcpu"));
        ...
        if (!isHelpSubCat) {
            ...
            ui->helpSplitter->widget(1)->show();
            if (row == ePR1228) {
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/prob1228.pepcpu"));
        ...
        if (!isHelpSubCat) {
            ...
            ui->helpSplitter->widget(1)->show();
            if (row == ePR1234A) {
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/prob1234a.pepcpu"));
                ...
                ui->helpTextEdit->setPlainText(Pep::resToString(":/help-cpu/figures/prob1234b.pepcpu"));
