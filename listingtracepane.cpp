...
void ListingTracePane::updateListingTrace()
{
    ...
    QTableWidget *tableWidget;
#pragma message("Enable CPU saying if it is in a trap")
    if (false){//Sim::trapped) {
        tableWidget = ui->listingPepOsTraceTableWidget;
    ...
    #pragma message("Enable line highlighting")
    /*
...
{
    emit labelDoubleClicked(Enu::EPane::EListingTrace);
}
