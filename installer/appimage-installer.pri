...
QMAKE_POST_LINK += \
    ...
    $${QMAKE_COPY} $$cleanPathQuote($$LINUX_DESKTOP_FILE_PATH/$$LINUX_DESKTOP_FILE) $$cleanPathQuote($$OUT_PWD/Installer/usr/share/applications) $$psc \

QMAKE_POST_LINK += $$cleanPathQuote($$QtDir/bin/linuxdeployqt) $$cleanPathQuote($$OUT_PWD/Installer/usr/share/applications/$$LINUX_DESKTOP_FILE)$$psc
