...
UNIVERSAL_ICONS = ""
WINDOWS_ICONS = "../pep9micro-lib/images/icon.ico" "../pep9micro-lib/images/Pep9micro-icon.png"
MAC_ICONS = "../pep9micro-lib/images/icon.icns" "../pep9micro-lib/images/Pep9micro-icon.png"
LINUX_ICONS = "" #No implementation for Linux

# Path where the installer config files may be found
INSTALLER_CONFIG_PATH = $$PWD/../../installer/packages/pep9micro

#  Needed for appimage in linux
LINUX_ICON = $$PWD/../pep9micro-lib/images/Pep9micro-icon.png
LINUX_ICON_THEME = "hicolor"
LINUX_ICON_SIZE = "512x512"
LINUX_DESKTOP_FILE_PATH = $$PWD/../../installer/packages/pep9micro
